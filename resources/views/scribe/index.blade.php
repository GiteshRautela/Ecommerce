    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-GETapi-orders">Display a listing of the resource for the authenticated user.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-admin-orders">
                                <a href="#endpoints-GETapi-admin-orders">Display a listing of all orders for admin.</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>Must be at least 1. Example: <code>22</code></p>
                    ...
                    <h2 id="endpoints-GETapi-orders">Display a listing of the resource for the authenticated user.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-admin-orders">Display a listing of all orders for admin.</h2>
